...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onSuccess }) => {
  const { loginWithEmail, registerWithEmail, loginWithGoogle, isLoading, error, clearError } = useAuth();
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white border-2 border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all font-semibold text-slate-700 shadow-sm disabled:opacity-60 disabled:cursor-wait"
              >
